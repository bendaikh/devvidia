        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    @endif
                    @if(!empty($page->settings['facebook_pixel_id']))
                    <span style="display: inline-flex; align-items: center; gap: 0.25rem; margin-left: 0.5rem; padding: 0.25rem 0.5rem; background: #1877f2; color: #fff; border-radius: 4px; font-size: 0.75rem; font-weight: 500;" title="Facebook Pixel: {{ $page->settings['facebook_pixel_id'] }}">
                        <svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor">
